...
/*---------------------------------------------------------------------------------------------------------*/
  ...
  */   
  ...
  AD0 = int(tensao*100.0); // Valor de 0 a 1023 e será necessário dois bytes para representar
  ...
  AD1 = int(corrente*100.0);
  pkt->AD1[0] = 2; // Pode ser utilizado para indicar o tipo de sensor o byte 19

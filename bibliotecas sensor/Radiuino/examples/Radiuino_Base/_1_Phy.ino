...
// Copyright (c) 2015
// Author: Pedro Henrique Gomes, Omar C. Branquinho, Tiago T. Ganselli, Debora M. Ferreira
...
{  
  ...
  * !! ATENÇÃO !!: Potencias maiores que 0dBm podem fazer com que as placas percam a comunicação quando estão muito próximas.
  *                Recomendamos posicioná-las com uma distância mínima de 1 metro. */
  power = 7;                 

  /********** CANAL DE COMUNICAÇÃO **********/
  /* Pode ser escolhido de 0 a 65. Os canais estão espaçados de 200kHz e dispostos na faixa de 915 a 928 MHz */
  channel = 0;               /* Canal */
  
  /********** AJUSTE DE OFFSET **********/
  /* A diferença de frequência dos cristais de cada placa deve ser compensada.
...
void PHY::initialize(void)
{
  ...
  /* Acende o Led vermelho nos kits DK101, DK102 e DK103 indicando que o sensor foi acionado */
  digitalWrite (4, HIGH); 
...
{
  /* Carrega a primeira Configuracao (pode ser inserida mais de uma Configuracao no código) */
  cc1101.Setup(0);
  
  /* Configura o endereco do rádio */
...
inline int PHY::receive(packet * pkt)
{
  ...
  /* Coloca a informacao de RSSI e LQI no cabecalho da camada física */
  pkt->PhyHdr[2] = rssi;
  pkt->PhyHdr[3] = lqi;
...
/* Instanciacao do objeto de acesso a classe da camada Física */
PHY Phy = PHY();

...
{  
 /********** AJUSTE DE Potencia *************/
 /* A Potencia de transmissao pode ser escolhida entre 8 valores poss�veis (0 a 7).
  ...
  * !! ATEN��O !!: Potencias maiores que 0dBm podem fazer com que as placas percam a comunica��o quando est�o muito pr�ximas.
  *                Recomendamos posicion�-las com uma dist�ncia m�nima de 1 metro. */
  power = 7;                 

  /********** CANAL DE COMUNICA��O **********/
  /* Pode ser escolhido de 0 a 65. Os canais est�o espa�ados de 200kHz e dispostos na faixa de 915 a 928 MHz */
  channel = 0;               /* Canal */
  
  /********** AJUSTE DE OFFSET **********/
  /* A diferen�a de frequ�ncia dos cristais de cada placa deve ser compensada.
...
void PHY::initialize(void)
{
  ...
  /* Configura o offset de frequ�ncia */

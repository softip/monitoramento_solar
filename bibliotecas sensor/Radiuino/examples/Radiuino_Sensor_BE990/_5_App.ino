...
inline void APP::receive(packet * pkt) 
{
  ...
  AD0 = analogRead(AD0_PIN); // Valor de 0 a 1023 e ser� necess�rio dois bytes para representar
  ...
  pkt->AD1[1] = (byte) (AD0/256); // Valor inteiro no byte 20
  pkt->AD1[2] = (byte) (AD0%256); // Resto da divis�o noo byte 21

  // AD2 - pino 12 do BE900
  AD2 = analogRead(AD2_PIN);
  pkt->AD2[0] = 2; // Pode ser utilizado para indicar o tipo de sensor o byte 22
  pkt->AD2[1] = (byte) (AD0/256); // Valor inteiro no byte 23
  pkt->AD2[2] = (byte) (AD0%256); // Resto da divis�o noo byte 24

  // AD3 - pino 11 do BE900
  AD3 = analogRead(AD3_PIN);
  pkt->AD3[0] = 3; // Pode ser utilizado para indicar o tipo de sensor o byte 25
  pkt->AD3[1] = (byte) (AD0/256); // Valor inteiro no byte 26
  pkt->AD3[2] = (byte) (AD0%256); // Resto da divis�o noo byte 27

  // AD4 - pino 20 do BE900
  AD4 = analogRead(AD4_PIN);
  pkt->AD4[0] = 0; // Pode ser utilizado para indicar o tipo de sensor o byte 28
  pkt->AD4[1] = (byte) (AD0/256); // Valor inteiro no byte 29
  pkt->AD4[2] = (byte) (AD0%256); // Resto da divis�o noo byte 30

  // AD5 - pino 19 do BE900
  AD5 = analogRead(AD5_PIN);
  pkt->AD5[0] = 0; // Pode ser utilizado para indicar o tipo de sensor o byte 31
  pkt->AD5[1] = (byte) (AD0/256); // Valor inteiro no byte 32
  pkt->AD5[2] = (byte) (AD0%256); // Resto da divis�o noo byte 33

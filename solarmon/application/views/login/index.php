...
<div class="login-box">
  <div class="login-logo">
      <a href="#"><b>Monitoramento Solar</b></a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Entre para iniciar sua sessão.</p>

    <form action="<?= site_url("login/verificar") ?>" method="post">
    ...
    <a href="#">Esqueci minha senha Minha controler<?php echo $this->router->class ?></a><br>
  </div>
